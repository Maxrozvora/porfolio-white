                        ...
                        <div class="col-md-12">
                            <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                <div class="col-md-12">
                                    <div class="about-desc">
                                        ...
                                        <p>Using in my project Bootstrap, Vue, Vuetify, Modx, YII2.</p>
                            ...
                            <div class="row">
                                <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                                    <div class="hire">
                                        <h2>
                                        Still looking for a  front end developer? <br>
                                        What do you waiting for?
                                        </h2>
                                        <a href="#contact" class="btn-hire" data-nav-section="education">Hire me</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<i class="icon-data"></i>
                                ...
                                <div class="desc">
                                    <h3>Software</h3>
                                    <p>Development and support online store, landing page.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-center animate-box">
...
<i class="icon-phone3"></i>
                                ...
                                <div class="desc">
                                    <h3>Application</h3>
                                    <p>Creating Android APK via Vue and Cordova</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-center animate-box">
...
<i class="icon-layers2"></i>
                                ...
                                <div class="desc">
                                    ...
                                    <p>Working with graphic editor Photoshop, Figma</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="colorlib-skills" data-section="skills">
                <div class="colorlib-narrow-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                            <p>Here is the list of my skills where you can check my level of using different languages, libraries, frameworks and other abilities. </p>
                        </div>
                        ...
                        <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                            <div class="progress-wrap">
                                <h3>Figma</h3>
                                <div class="progress">
                                    <div class="progress-bar color-2" role="progressbar" aria-valuenow="63"
                                ...
                                <article class="timeline-entry animate-box" data-animate-effect="fadeInRight">
                                    <div class="timeline-entry-inner">
                                        ...
                                        <div class="timeline-label">
                                            ...
                                            <p>Working with Vue, YII2. Creating android app.</p>
                                        </div>
                                    </div>
                                </article>
            ...
            <section class="colorlib-work" data-section="work" id="work">
                <div class="colorlib-narrow-content">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box"
                             data-animate-effect="fadeInLeft">
                    ...
                    <div class="row">
                        [!multiTV? &tvName=`works` &display=`10`!]
                    </div>
                </div>
            </section>
